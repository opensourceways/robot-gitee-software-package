...
func (impl *pullRequestImpl) appendToSigInfo() error {
	...
	fileName := fmt.Sprintf(impl.cfg.PR.ModifyFiles.SigInfo,
...
func (impl *pullRequestImpl) newCreateRepoYaml() error {
	...
	fileName := fmt.Sprintf(impl.cfg.PR.ModifyFiles.NewRepo,
...
func (impl *pullRequestImpl) branchName() string {
	return fmt.Sprintf(impl.cfg.PR.BranchName, impl.pkg.Name)
}

func (impl *pullRequestImpl) prName() string {
	return fmt.Sprintf(impl.cfg.PR.PRName, impl.pkg.Name)
}
...
func (impl *pullRequestImpl) createPRWithApi() (dpr domain.PullRequest, err error) {
